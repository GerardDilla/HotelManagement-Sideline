...
class paypal_lib {
	...
	{		
		...
		#CREDENTIALS
		$this->client_id = 'AUYeKzZondVvpJj5JAloby7tD7NDH1s3olZzj_pArLsJzkvzp2TzlY5UcoMYFxEw6daWYD5gKBJImwkJ';
		$this->secret_id = 'ELk6t1VQhDnbFFHOCFYhr5-C0k-JYJeio2q2qQaEzsTnpFxG3fuPG6Ge3R3fINW08XsprBnW_huA9eVK';
	}
	...
	function paypal_refund($token = '',$saleid =''){

		$ch = curl_init();

		curl_setopt($ch, CURLOPT_URL, 'https://api-m.sandbox.paypal.com/v1/payments/sale/'.$saleid.'/refund');
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
		curl_setopt($ch, CURLOPT_POST, 1);
	...
	function paypal_client_token($token = ''){
