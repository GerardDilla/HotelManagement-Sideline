	...
	<div class="container">
		<div class="services-top-breadcrumbs-right">
			<ul>
                ...
                <li><a  class = "rates"href="<?php echo site_url('facility')?>">Facility</a> <i>/</i></li>
				<li><?php echo $facility->title ?></li>
			</ul>
		</div>
		<div class="services-top-breadcrumbs-left">
			<h3 class = "rates"><?php echo $facility->title ?></h3>
		</div>
...
<?php $ft_image	=	get_room_type_featured_image_medium($facility->id);?>
