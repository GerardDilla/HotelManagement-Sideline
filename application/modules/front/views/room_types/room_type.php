	...
	<div class="container">
		<div class="services-top-breadcrumbs-right">
			<ul>
                ...
                <li><a  class = "rates"href="<?php echo site_url('rooms')?>">Rooms</a> <i>/</i></li>
				<li><?php echo $room_type->title ?></li>
			</ul>
		</div>
		<div class="services-top-breadcrumbs-left">
			<h3 class = "rates"><?php echo $room_type->title ?></h3>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                    ...
                    <div class="carousel-inner" role="listbox">
                      ...
                      foreach($images as $img):?>      
                          <div class="item <?php echo ($slide_img_index == 0 ) ? 'active' : ''; ?>">
                            <img src="<?php echo base_url('assets/admin/uploads/gallery/medium/'.$img->image)?>" class="img-responsive" style="width:100%;height:500px;" />
                          </div>
                      <?php 
                      $slide_img_index++;
                      endforeach; 
                ...
                <p class = "rates" style = "font-size:21px;"<?php echo $room_type->description ?></p>
                <?php endif; ?>
                
                <h4 class="sub-title rates"><?php echo lang('amenities');?></h4>
				...
				<?php endforeach; ?>
                 <br>
                 <br>
                <h4 class = "rates"><?php echo lang('start')?> <?php echo lang('from')?> <?php echo $this->session->userdata('currency_sybmol'); ?> <?php echo rate_exchange($room_type->base_price)?>  /<?php echo lang('per_night');?></h4>	
				</ul>
                
            </div>
            <div class="col-md-4">
                
        		<h3  class = "contentdesc"><span><?php echo lang('make_reservation')?></span></h3>
                <br />
                <form method="get" action="<?php echo site_url('front/book/index')?>">
            		...
            		<div class="reservation">
                        ...
                        <input type="button" class = "availbtn" name="room_type" value="<?php echo @$_GET['room_type']?>" />
                        <div class="keywords">  
        ...
        $(function() {
        	...
        	$('.datepicker2').datepicker({
        	   ...
        	   startDate: new Date(),
        		...
        		if(date2<date1){
        			toastr.error('Checkout date must be greater than Checkout date');
        			$('.datepicker2').val('');
        			$('.datepicker2').focus();
        		}
        	});
