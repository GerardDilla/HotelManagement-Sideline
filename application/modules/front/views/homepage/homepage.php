...
.list ul li {
 ...
 <div class = "section bg-orange">
  <div class = "container">
  <div class = "row">
<h4 class = "hometitle">Hotel Dominico - The perfect place for your stay in Cavite</h4>
<p class = "homedescription">We at Hotel Dominico offer a unique experience for all types of guests. Families, friends, and business travelers, may select from our various room types with stylish and functional amenities offering you a unique and memorable experience. We’re located in Bacoor Cavite, only minutes away from the Airport, Pasay, Paranaque, & The Mall of Asia. With shopping malls, supermarkets, restaurants, churches, in our immediate vicinity, we are conveniently close to everything you need and everywhere you need to be.</p>
...
<!-- special-services -->
<div class="special-services bg-white">
	<div class="container">
		<h3 class = "contentdesc"><span><?php echo $this->setting->content_section_title?></span></h3>
		<hr>
		...
		<div class="special-services-grids">
			...
			<div class="col-md-3 special-services-grid">
				<div class="special-services-grid1 card">
					<img src="<?php echo $rt_image; ?>" alt="<?php echo $rt->title?>" class="img-thumbnail card-img" />
				</div>
				<div class = "card-body">
				<h4 class="text-center rates"><a href="<?php echo site_url('rooms/'.$rt->slug)?>"><?php echo $rt->title?></a></h4>
			</div>
			</div>
...
<div class="special-services">
	<div class="container">
		<h3 class = "contentdesc"><span><?php echo lang('latest_deals')?></span></h3>
		<p class="autem"><?php echo $this->setting->content_section_description?></p>
		<div class="special-services-grids">
...
<div class="testimonials">
	<div class="container">
		<h3  class = "contentdesc"><span><?php echo lang('reviews')?></span></h3>
		<p class="autem">Latest reviews from our satisfied clients</p>
