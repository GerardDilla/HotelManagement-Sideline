...
<div class="testimonials">
    <div class="container">
        <div class="row">
			    ...
			    <h3 class = "contentdesc col-md-12" style="text-align:center"><span><?php echo lang('payment_from_stripe')?></span></h3>

          <div class="col-md-12 panel panel-primary margin-40-y">

            <div style="text-align:center">
              <br><br>
              <h2>Amount:   <b>PHP<?php echo $booking_data['amount'] ?></b></h2>
              <br><br>
            </div>
        ...
        createOrder: function(data, actions) {
         ...
         onApprove: function(data, actions) {
           return actions.order.capture().then(function(details) {
             window.location.href = '/testsuccess';
           });
         }
         ...
         fields: {
          ...
          document.querySelector("#card-form").addEventListener('submit', (event) => {
           ...
           cardFields.submit({
            ...
            window.location.replace('./paypalcard_success/'+orderId);
          }).catch(function (err) {
