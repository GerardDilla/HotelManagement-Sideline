 <!-- Main content -->
      ...
      <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text"><span style = "font-size:19px;font-family:'Exo 2';"><?php echo lang('total_bookings')?></span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text"><span style = "font-size:19px; font-family:'Exo 2';"><?php echo lang('today_revenue')?></span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text"><span style = "font-size:19px;font-family:'Exo 2';"><?php echo lang('avail_rooms')?></span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text"><span style = "font-size:19px;font-family:'Exo 2';"><?php echo lang('total_guests')?></span>
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"><h3 style = "font-size:25px;font-family:'Exo 2';">Weekly Revenue Report</h3>
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
                  <p class="text-center">
                    <strong style = "font-size:18px;font-family:'Exo 2';">Revenue: <?php echo date('Y-m-d', strtotime('- 6 days'))?> - <?php echo date('Y-m-d');?></strong>
                  </p>
	...
	<div class="row">
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"><h3 style = "font-size:25px;font-family:'Exo 2';"><?php echo lang('weekly_occupancy_report')?></h3>
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
                  <p class="text-center">
                    <strong style = "font-size:18px;font-family:'Exo 2';"><?php echo lang('occupancy_report')?>: <?php echo date('Y-m-d', strtotime('- 6 days'))?> - <?php echo date('Y-m-d');?></strong>
                  </p>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
		  ...
		  <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"><h3 style = "font-size:25px;font-family:'Exo 2';"><?php echo lang('latest_bookings')?></h3>
            ...
            <div class="box-body">
              <div class="table-responsive">
                <table class="table no-margin">
                  <thead>
                  <tr>
                    <th style = "font-size:17px;"><?php echo lang('booking_number')?></th>
                    <th style = "font-size:17px;"><?php echo lang('guest')?></th>
                    <th style = "font-size:17px;"><?php echo lang('payment') ?></th>
                    <th style = "font-size:17px;"><?php echo lang('room') ?></th>
                  </tr>
                  </thead>
                  <tbody>
