						...
						<?php $i=1;foreach ($payments as $new):?>
								<tr>
									...
									<td>
										...
										<form action="<?php echo base_url(); ?>admin/bookings/refund" class="refundform" method="post">
											...
											<?php if($new->remarks != 'Refunded'): ?>
												<button class="btn btn-danger refund" type="button" data-orderid="<?php echo $order_id; ?>" data-paymentid="<?php echo $new->id?>" href="#Refund"></i> Refund</button>
												<input type="hidden" name="orderid" value="<?php echo $order_id; ?>">
												<input type="hidden" name="paymentid" value="<?php echo $new->id?>">
											<?php endif; ?>
										</form>
										</div>
									</td>
					  ...
					  <div class="form-group">
                        ...
                        <div class="form-group">
                        	<div class="row">
								...
								<div class="col-md-8">
                                    <input type="text" name="remarks" value="<?php echo $new->remarks?>" class="form-control" required/>
                                </div>
                            </div>
                        </div>
...
$('.refund').click(function(){
	...
	if (confirm('Are you sure you want to Refund? '+orderid+' : '+paymentid)){
		$('.refundform').submit();
	}else{
		return;
	}
