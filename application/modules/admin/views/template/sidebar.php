...
<!-- Left side column. contains the logo and sidebar -->
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <li class="<?php echo ($this->uri->segment(2)=='inventory')?'active':''?>"><a href="<?php echo site_url('admin/inventory')?>"><i class="fa fa-circle-o"></i> Inventory</a></li>
      ...
      <li class="<?php echo ($this->uri->segment(2)=='facilities')?'active':''?>"><a href="<?php echo site_url('admin/facilities')?>"><i class="fa fa-circle-o"></i> <span><?php echo lang('facilities');?></span></a></li>
		...
		<li class="treeview <?php echo($this->uri->segment(2)=='settings' || $this->uri->segment(2)=='languages' || $this->uri->segment(2)=='currency' ||$this->uri->segment(2)=='locations'||$this->uri->segment(2)=='taxes'||$this->uri->segment(2)=='testimonials')?'active':'';?>">
          ...
          <ul class="treeview-menu">
			...
			<li class="<?php echo ($this->uri->segment(2)=='testimonials')?'active':''?>"><a href="<?php echo site_url('admin/testimonials')?>"><i class="fa fa-circle-o"></i> <span><?php echo lang('reviews');?></span></a></li>
