                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                                ...
                                <div class="box-body">
                                   <div class="row">
                                    ...
                                    <div class = "row">
                                        <div class = "col-md-12">
                                             <label>
                                                <input type="checkbox" class="icheck" data-type="page" data-title="<?php echo lang('facilities')?>"
                                                value="facilities"/> &nbsp;<?php echo lang('facilities')?>
                                            </label>
                                        </div>
                                    </div>
                                    <div class = "row">
                                        <div class = "col-md-12">
                                             <label>
                                                <input type="checkbox" class="icheck" data-type="page" data-title="<?php echo lang('calendar')?>"
                                                value="calendar"/> &nbsp;<?php echo lang('calendar')?>
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="box box-solid bg-teal collapsed-box">
                                ...
                                <div class="box-body">
                                    <?php foreach($facility as $category){ ?>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label>
                                                <input type="checkbox" class="icheck" data-type="category" data-title="<?php echo ucwords($category->title)?>"
                                                value="<?php echo site_url('facility')?>/<?php echo $category->slug?>"/> &nbsp;<?php echo ucwords($category->title)?>
                                            </label>
                                        </div>
                                    </div>
                                    <?php }?>   
