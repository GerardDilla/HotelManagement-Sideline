...
class Login extends CI_Controller {
	...
	{	
		...
		if ($submitted)
		{
			...
			{	
				...
				if ($redirect == '')
				{
					$this->session->set_flashdata('message', 'Welcome to Hotel Dominico!');
					$redirect = 'admin/dashboard';
				}
				redirect($redirect);
			}
			else
			{
				...
				$this->session->set_flashdata('error', 'Log In Failed');
	...
	function logout()
	{
		...
		$this->session->set_flashdata('message', "Logged out Success");
		redirect('admin/login');
	}
