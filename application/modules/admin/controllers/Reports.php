...
class Reports extends Admin_Controller {
	...
	{	
		...
		$data['customdata']	=	array();
				// 7 DAYS Week Chart
						$weekstart	=	date("Y-m-d", strtotime("-1 DAYS"));
						$wbegin = new DateTime($weekstart);
						$wend = new DateTime(date('Y-m-d', strtotime("+ 6 DAYS")));
						...
						$mbegin = new DateTime(date("Y-m-d", strtotime(" -1 DAYS")));
						$mend = new DateTime(date('Y-m-d', strtotime("+ 30 DAYS")));
						...
						$start = $month = strtotime("- 65 days");
						$end = strtotime('+ 300 day');
						$i=0;
						while($month < $end)
						{
