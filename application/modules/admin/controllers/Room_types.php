...
class Room_types extends Admin_Controller {
	...
	function form($id = false)
	{
		...
		$data['images']	= array();
		$data['roomtype']			=	$rtype		= $this->room_type_model->get_all1();
		...
		{	
			...
			$data['id']								= $rtype->id;
			$data['title']							= $rtype->title;
			$data['maintenance_mode']				= $rtype->maintenance_mode;
			$data['room_block_period']				= $rtype->room_block_start_date.' / '.$rtype->room_block_end_date;
		}
		if ($id)
		{	
			$data['room_type']			=	$room_type		= $this->room_type_model->get($id);
			...
			$data['maintenance_mode']	= $room_type->maintenance_mode;
			$data['room_block_period']	= $room_type->room_block_start_date.' / '.$room_type->room_block_end_date;
